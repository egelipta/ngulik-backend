        ...
        if not device:
            ...
            try:
                ...
                if (response.status_code == 200):
                    ...
                    if data_id and data_id[0] and 'employeeNoString' in data_id[0]:
...
async def buka_lantai(id_person:str):
    ...
    data_lantai = await Elevator.get(id_person=id_person)
...
def tutup_lantai():
    ...
    if lantai_binary == all_lantai:
        ...
        print("Lantai binary: ", lantai_binary)
